...
| `assets/encounters/` | 1 | 2.46 MiB | Runtime bunker gauntlet plate |
...
and six promoted props, the expected checkout is roughly 473 files / 63 MiB.
...
The conservative literal runtime closure is 101 files / 48.98 MiB. The gap is
not deleted automatically: it contains fallbacks, README media, vendor sources,
and older art whose provenance should be retained before removal.
