...
- **Optional Investigations**: Xi and Kim now use the same authored-room contract to turn surveillance and the Red Phone into environmental consequences rather than generic bonus rooms.
