...
# Ironic Death (Portrait & Sprite same basis)
process(os.path.join(base, "death_portrait_ironic_paracula_1774662071110.png"), os.path.join(dest, "assets/mockups/death_ironic.png"))
